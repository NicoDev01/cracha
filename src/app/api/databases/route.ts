...
import { authenticated, type AuthenticatedRequest } from '@/lib/auth/middleware'
...
async function handleGetDatabases(_request: AuthenticatedRequest): Promise<NextResponse> {
  try {
