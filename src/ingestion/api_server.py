...
async def crawl_endpoint(request: CrawlRequest):
    ...
    try:
        ...
        # Execute the command in the original ingestion directory
        # Go up to project root, then to original ingestion directory
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
        original_ingestion_dir = os.path.join(project_root, "ingestion")
        
        print(f"Executing in directory: {original_ingestion_dir}")
