...
function parseIncompleteMarkdown(text: string): string {
  ...
  if (inlineCodeMatch) {
    ...
    const _hasCodeBlockStart = result.includes('```'); // Checked but logic may be simplified later
    const codeBlockPattern = /```[\s\S]*?```/g;
    const _completeCodeBlocks = (result.match(codeBlockPattern) || []).length; // Used for validation
