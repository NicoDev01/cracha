  ...
  return (
    <section className="space-y-8 py-12 sm:py-20 lg:py-16">
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-5 px-4 text-center sm:px-6 lg:px-8">
        <p className="text-sm font-medium text-muted-foreground">Für Agenturen, Marketing-Teams und Entwickler</p>
        ...
        <p className="max-w-2xl text-pretty leading-relaxed text-muted-foreground sm:text-xl">
          Statt dich durch Dutzende Unterseiten zu klicken, fragst du einfach: CraCha liest Firmenwebsites
          und Dokumentationen ein und beantwortet deine Fragen auf Deutsch – jede Antwort mit klickbarem Link
          zur Quellseite.
        </p>
        ...
        <p className="max-w-xl text-sm text-muted-foreground">
          100 Start-Credits gratis · Keine Kreditkarte nötig · Auf Deutsch
        </p>
      </div>
    </section>
  );
