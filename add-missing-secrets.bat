...
type nul | set /p="77gSlb7YkPC-Cs9xOvrf6O9qW76tGnnaM38-NXIA" | wrangler secret put CLOUDFLARE_API_KEY
type nul | set /p="29bd2f55dbea6d4937d4f234dbc7bee582d4b" | wrangler secret put CLOUDFLARE_API_TOKEN
type nul | set /p="Aimpact.agency@gmail.com" | wrangler secret put CLOUDFLARE_EMAIL
...
type nul | set /p="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" | wrangler secret put OPENAI_API_KEY
...
type nul | set /p="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5jZnJnc3FmbmNjamZ5ZXp4anNqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQ4NTg0NDAsImV4cCI6MjA3MDQzNDQ0MH0.Q3OaTFVoPtcC1VLYI1hZAJrDtXLNaMnfjCPx9bvogmk" | wrangler secret put NEXT_PUBLIC_SUPABASE_ANON_KEY
type nul | set /p="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5jZnJnc3FmbmNjamZ5ZXp4anNqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NDg1ODQ0MCwiZXhwIjoyMDcwNDM0NDQwfQ.jn9_u3HcwVnFqYVM_pPzSmrQvEWU14jU213xUs1p3VA" | wrangler secret put SUPABASE_SERVICE_ROLE_KEY
