...
export function ChatInterface() {
  ...
  return (
    <div className="relative h-full flex flex-col">
      ...
      <div className="h-[100px] flex-shrink-0 p-3 lg:p-4 border-t border-gray-200 dark:border-gray-800 bg-white/95 dark:bg-gray-900/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 shadow-[0_-6px_12px_rgba(0,0,0,0.04)] pb-[env(safe-area-inset-bottom)]">
