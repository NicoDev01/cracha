...
export function ChatInterface() {
  ...
  return (
    <>
      {/* Header Controls */}
      <div className="hidden lg:block flex-shrink-0 p-6 border-b border-gray-200 dark:border-gray-700 bg-white/70 dark:bg-gray-900/40 backdrop-blur">
      ...
      {/* Chat Layout: strictly separated content (scroll) and input (fixed row) */}
      <div className="flex-1 min-h-0 grid grid-rows-[1fr,auto]">
        {/* Scrollable Conversation Area */}
        <Conversation className="min-h-0 overflow-y-auto">
          <ConversationContent className="p-3 sm:p-4 lg:p-6 space-y-2">
            {messages.length === 0 ? (
              <div className="hidden lg:flex flex-col items-center justify-center min-h-[50vh] py-12 text-center">
        ...
        <div className="row-start-2 p-3 lg:p-4 border-t border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/70 backdrop-blur supports-[backdrop-filter]:bg-white/60">
