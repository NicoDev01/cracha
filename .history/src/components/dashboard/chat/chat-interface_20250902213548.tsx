  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        <Conversation className="flex-1 max-h-[calc(100dvh-200px)] lg:max-h-[calc(100dvh-160px)]">
          <ConversationContent className="p-2 pb-4 sm:p-4 sm:pb-6">
            {messages.length === 0 ? (
        ...
        {/* Input Area */}
        <div className="flex-shrink-0 p-3 lg:p-4 border-t border-gray-200 dark:border-gray-800 bg-white/95 dark:bg-gray-900/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 shadow-[0_-6px_12px_rgba(0,0,0,0.04)] pb-[env(safe-area-inset-bottom)]">
