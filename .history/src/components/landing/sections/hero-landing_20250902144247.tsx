  ...
  return (
    <section className="space-y-6 py-12 sm:py-20 lg:py-16">
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-5 px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          Mit nur einem Klick verwandelt CraCha gesamte Webseiten in Ihren individuellen Experten. Während andere Tools nur eine einzelne Seite erfassen, oder ohne Kontrolle wild das Web durchsuchen, erfassen wir den kompletten Kontext von Websites, Docs und Sitemap strukturen in all ihrer Komplexität für Sie. Stellen Sie einfach Ihre Frage und erhalten Sie präzise, quellenbasierte Antworten aus dem gesamten Wissensschatz der hunderter von Seiten.
        </p>
