  ...
  return (
    <>
      ...
      <div className="h-screen flex flex-col relative">
        ...
        {/* Chat Conversation Area - Takes remaining space minus input height */}
        <div className="flex-1 rounded-t-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] flex flex-col overflow-hidden pb-24">
          <ChatConversation />
        </div>

        {/* Chat Input Area - Absolutely positioned at bottom */}
        <div className="absolute bottom-0 left-0 right-0 h-24 rounded-b-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-white/[0.03]">
          <ChatInput />
        </div>
      </div>
    </>
